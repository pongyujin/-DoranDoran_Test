...
<div class="control-panel">
    <div class="arrow-buttons">
        <img src="<%= request.getContextPath() %>/resources/img/left.png" alt="left" class="arrow-icon">
        <img src="<%= request.getContextPath() %>/resources/img/top.png" alt="top" class="arrow-icon">
        <img src="<%= request.getContextPath() %>/resources/img/right.png" alt="right" class="arrow-icon">
    </div>
   
</div>
<img class="stop-icon"src="<%= request.getContextPath() %>/resources/img/stop.png" alt="멈추기 아이콘" width="40" height="40">
