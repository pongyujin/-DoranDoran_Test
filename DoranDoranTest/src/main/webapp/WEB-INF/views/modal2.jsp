    ...
    <div id="loginModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="social-login">
                <!-- 소셜 로그인 버튼들 -->
                <!-- Google Login -->
                <a href="https://accounts.google.com/o/oauth2/v2/auth?client_id=${googleClientId}&redirect_uri=http://localhost:8085/controller/main2/oauthcallback&response_type=code&scope=email profile&state=google" class="social-btn google">
                    <img src="<%=request.getContextPath()%>/resources/img/google_logo.png" alt="Google" />
                </a>
                <!-- Kakao Login -->
                <a href="https://kauth.kakao.com/oauth/authorize?client_id=${kakaoClientId}&redirect_uri=http://localhost:8085/controller/main2/oauthcallback&response_type=code&state=kakao" class="social-btn kakao">
                    <img src="<%=request.getContextPath()%>/resources/img/kakao_logo.png" alt="Kakao" />
                </a>
                <!-- Naver Login -->
                <a href="https://nid.naver.com/oauth2.0/authorize?client_id=${naverClientId}&redirect_uri=http://localhost:8085/controller/main2/oauthcallback&response_type=code&state=naver" class="social-btn naver">
    ...
    <div id="shipRegisterModal" class="modal" style="display: none;">
        ...
        <div class="modal-content">
            <form action="shipRegister" method="post" enctype="multipart/form-data">
                ...
                <input type="text" id="siCode" name="siCode" placeholder="Ship ID" pattern="[A-Za-z0-9]+" required title="영문자와 숫자만 입력 가능" maxlength="20" readonly>
    ...
    <div id="editModal" class="modal">
        ...
        <div class="modal-content">
            <form action="memberUpdate" method="post" onsubmit="return validateForm();">
                ...
                <input type="password" id="pwCheck" name="pwCheck" placeholder="Current Password" required>
